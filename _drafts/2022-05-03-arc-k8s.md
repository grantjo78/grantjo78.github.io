...
Within the Hyper-V host, I've deployed a two virtual machines running Ubuntu 20.04.4 LTS:
- k3s-1
- k3s-2
...
I'm utilising [K3s](https://k3s.io/) to create my Kubernetes cluster as it's very quick to setup and lightweight. To setup the cluster is I followed the K3s [quickstart guide](https://rancher.com/docs/k3s/latest/en/quick-start/).
